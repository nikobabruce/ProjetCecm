	...
	<table id="dataTable" class="table table-striped table-bordered">
		<thead>
			<tr>
				...
				<th></th>
				<th>
					<a href="<?=base_url()?>index.php/welcome/add_group" class="btn btn-primary btn-sm">Add Group</a>
				</th>
			</tr>
		</thead>
		<tbody>
			<?php foreach($groups as $key => $user_profile) : ?>
			<tr>
			    <td><?php echo ($key+1); ?></td>
				<td><?php echo $user_profile ["usersgroup_name"]; ?></td>
				<td><?php echo $user_profile ["usersgroup_description"]; ?></td>
				<td><?php echo $user_profile ["sortorder"]; ?></td>
				...
				<td>
					<a href="<?php echo base_url()?>index.php/welcome/edit_group/<?php echo $user_profile ["usersgroup_id"];?>" class="btn btn-primary btn-sm">Edit</a>
					<a href="<?php echo base_url()?>index.php/welcome/delete_group/<?php echo $user_profile ["usersgroup_id"];?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus?')">Delete</a>
				</td>
			</tr>
			<?php endforeach; ?>
		</tbody>
